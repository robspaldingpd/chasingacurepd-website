# Chasing a Cure Parkinson's Foundation — Messaging Guide

> *Built from love. Backed by science. Focused on the cure.*

This document is the single source of truth for all communications — website copy, marketing campaigns, donor outreach, sponsorship decks, social media, press, and event collateral. Pull from it directly; adapt tone to channel but keep the core language consistent.
...
| | |
|---|---|
| **Full name** | Chasing a Cure Parkinson's Foundation |
| **Type** | 501(c)(3) nonprofit, 100% volunteer-run |
| **EIN** | 82-5107944 |
| **Founded** | April 2018 |
| **Headquarters** | Fishers, IN (Indianapolis metro) |
| **Research partner** | The Michael J. Fox Foundation / Team Fox |
| **Website** | chasingacurepd.org |
| **Primary contact** | wendy@chasingacurePD.org |
...
> **Donations go directly to Parkinson's research through The Michael J. Fox Foundation and Team Fox.** We keep operating costs to the bare minimum required to run the foundation — event expenses, processing fees, and the tools we need to function. No one draws a salary. Everything else funds the science.

This is the sentence we stand behind. It is true, specific, and does not require us to defend a number we cannot prove to the penny.

---

## 4. The Three Repeating Lines

These three lines anchor every piece of communication. Use them verbatim, together or individually, across every channel.

1. **Science fuels hope.**
2. **We fund the science behind breakthroughs.**
3. **Your gift flows directly to the research.**

They work because they are true, specific, and emotionally coherent. Do not paraphrase them.
...
| Use | Tagline |
|---|---|
| Brand / identity | *Built from love. Backed by science. Focused on the cure.* |
...
## 6. Language: What We Say and What We Don't

### Keep ✓
- "Volunteer-run" — no one takes a salary, factually accurate
- "No salaries. No paid staff."
- "Founder-led"
- "Directly to research through MJFF and Team Fox"
- "Research-first"
- "The founders don't draw a dime."
- "We keep operations as lean as a foundation legally can."

### Retire ✗
These phrases are not defensible at the penny level — payment processing fees alone make them untrue. A donor who reads our 990 will notice. Retire them everywhere.

- "100% of every dollar to research"
- "100% to research"
- "Every penny goes to the cure" / "Every penny, straight to research"
- "Zero overhead" / "No overhead"
- "Zero administrative cut"
...
- *We publish our 990. Ask us anything.*

---

## 7. The Numbers That Matter

Use these facts in any order, in any channel. They establish urgency without manipulation.
...
| Event collateral | Celebratory, mission-forward, gratitude-forward |
...
Chasing a Cure Parkinson's Foundation was founded in April 2018, after co-founder Wendy Chase faced a truth no daughter wants to face: she could not save her mother Sue, and decided to turn that grief into something that could help other families. The Fishers, Indiana-based 501(c)(3) brings together over 4 combined decades of pharma, biotech, and health tech expertise — Wendy and co-founder Rob Spalding both built careers at Eli Lilly before founding this mission together.
...
### A. Individual donors (personally affected — caregivers, patients, family members)
...
## 12. Email Subject Lines (Swipe File)
...
| Matching gift | Your gift doubled — this week only |
| Final push | Last chance: Concert for a Cure tickets |
| Thank you | You moved the science forward |
| Post-event | We raised $[X] together. Here's what it funds. |

---

## 13. Website Copy Blocks
...
## 14. Donation Ask Amounts (Suggested Framing)
...
## 15. Key Proof Points for Credibility

Use these whenever a donor or sponsor asks "how do I know this is legitimate?"
...
- **Founders' industry backgrounds** — over 4 combined decades in pharma, biotech, and health tech; Eli Lilly alumni; they understand how research funding works and why timing matters
...
## 16. Guardrails for Future Copy

Before publishing any new donor-facing line, check:

1. Does it contain a number we cannot verify at the penny? → rewrite.
2. Does it imply zero costs of any kind? → rewrite.
3. Does it name the pathway (MJFF / Team Fox)? → good.
4. Does it say or imply someone is paid? → only say "volunteer" / "no salaries."
5. Would we be comfortable if a journalist pulled our 990 and compared? → if yes, ship it.

---

## 17. Quick-Reference Fact Sheet

```
Organization:    Chasing a Cure Parkinson's Foundation
EIN:             82-5107944
Type:            501(c)(3), 100% volunteer-run, no paid staff
Founded:         April 2018
Location:        Fishers, IN (Indianapolis metro)
Founders:        Wendy Chase & Rob Spalding
Research partner: The Michael J. Fox Foundation / Team Fox
Contact:         wendy@chasingacurePD.org
Address:         11650 Olio Road, Suite 1000-149, Fishers, IN 46037
Social:          Instagram | Facebook | LinkedIn

Key stats:
  10 million    People worldwide with Parkinson's
  1 million     People in the U.S. with Parkinson's
  90,000        New U.S. diagnoses per year
  0             Cures available today
  $185M+        Raised by Team Fox / MJFF since 2006

Primary tagline: Built from love. Backed by science. Focused on the cure.
Campaign tagline: Fuel the science. Fund the hope.
Three anchor lines:
  1. Science fuels hope.
  2. We fund the science behind breakthroughs.
  3. Your gift flows directly to the research.
...
*Last updated: April 2026. Source: chasingacurepd.org and campaign-brief-q-fundraising.md.*
